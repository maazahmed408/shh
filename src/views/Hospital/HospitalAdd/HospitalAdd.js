...
const Hospital_add = () => {
    ...
    async function handleFormSubmit(e) {
        ...
        let result = await axios.post(baseUrl + '/addHospital', item, { headers: { Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJhZG1pbiIsImlhdCI6MTY1MDM1NTIzMCwiZXhwIjoxNjUwNDQxNjMwfQ.q9GpBPhVBhSQ07z_rfLok3HIE1rIhodgFHOl6tmj0_Q` }});
        console.log(result)
