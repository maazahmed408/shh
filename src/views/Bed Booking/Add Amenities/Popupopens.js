    ...
    return (
        <>
            <div className="text alignLeft">
                <button onClick={showModalHandler2} style={{ position: 'absolute', right: '5px', top: '0px', border: 'none', color: 'red' }}>&#10006; </button>
                ...
                <div className="col-sm-12 text align-center mb-4 d-flex">
                    ...
                    <div className="col-sm-6"><button onClick={showModalHandler2} style={{ border: 'none', background: 'red', color: 'black', borderRadius: '5px' }}>Cancel</button></div>
                </div>
            </div>
        </>
    )
