...
import ReadOnlyRow1 from 'src/views/Bed Bookings/All Booking/ReadOnlyRow1';
import EditableRow1 from 'src/views/Bed Bookings/All Booking/EditableRow1';
import axios from 'axios';

const All_booking = () => {
  const [valueData, setvalueData] = useState([]);
  const resultDAta = async () => {
    const result = await axios.get(baseUrl + '/admin/getAllBookingRequests', {
      headers: {
        ...
        >
          <div className="info-box-5 hover-zoom-effect">
            ...
            >
              ...
              >
                <div className="text align-right" style={{ color: 'white' }}>
                  <FontAwesomeIcon
                    color="bluelight"
                    icon={faUserDoctor}
                    style={{ margin: '10px' }}
